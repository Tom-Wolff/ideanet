...
1. the `ideanet` package, [DOI:10.32614/CRAN.package.ideanet](https://doi.org/10.32614/CRAN.package.ideanet);
2. the Weir et al. (2017) CHAMP paper, [DOI:10.3390/a10030093](https://doi.org/10.3390/a10030093); and
3. the Gibson & Mucha (2022) CHAMP mapping paper, [DOI:10.1038/s41598-022-20142-6](https://doi.org/10.3390/a10030093).
...
```{r}
igraph::V(football)$label[partitions$partitions[[36]]$membership == 10]
```
