...
Now we see that everything in the figure flows towards the 12-community partition from both below and above, and we emphasize that the range of $\gamma$ for which this is the optimal partition does not straddle the default $\gamma=1$ value. 
```{r}
