...
Here we see that ego indicated some pairs of nodes as being connected as friends and others as being  connected as relatives. Each dyad is given its own row, and the type of relationship for each dyad is clearly identified in the `type` column.
