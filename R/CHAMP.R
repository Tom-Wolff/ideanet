...
#'
#' @returns \code{CHAMP} returns the input list of partitions with a $summary about which partitions are somewhere optimal (in the sense of modularity Q with a resolution parameter gamma) and their domains of optimality, along with the generated $CHAMPfig plot of the upper envelope of Q(gamma).
#' 
#' @export
#' 
#' @examples
