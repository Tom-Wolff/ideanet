#' Network Splitting
#'
#' @description This function is a prerequisite for using `netwrite` on multi-relational networks. It takes as arguments the standard vectors of ego IDs, alter IDs, edge weights, and relation types for edgelists.
#'
